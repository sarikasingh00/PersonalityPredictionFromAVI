...
# time_steps = 660 # Frames extracted from the video
# aud_ft = 20 # Number of Audio features extracted from each non overlapping frame
...
#         LSTM(20, return_sequences=True,dropout=0.4,recurrent_dropout=0.4),
...
#         SpatialDropout1D(0.3),
# #         LSTM(20, return_sequences=True,dropout=0.4,recurrent_dropout=0.4),
# #         LSTM(20, return_sequences=False,dropout=0.4,recurrent_dropout=0.4),
# #         CuDNNLSTM(10, return_sequences=True),
#         CuDNNLSTM(10, return_sequences=True, kernel_regularizer=l2()),
# #         Dropout(0.4),
#         CuDNNLSTM(10, return_sequences=False, kernel_regularizer=l2()),
#         Dropout(0.2),
...
#     [
#         Input(shape=(time_steps, aud_ft)),
#         CuDNNLSTM(20, return_sequences=False),
#         Dropout(0.5),
# #         Dense(10, activation=keras.activations.elu),
# #         Dropout(0.2),
#         Dense(5,activation='sigmoid'),
#     ],
#     name="classifier",
...
model.compile(
#     optimizer=[keras.optimizers.SGD(learning_rate=0.005, decay = 0.0005),keras.optimizers.SGD(nesterov=True),],
    optimizer=[keras.optimizers.RMSprop(learning_rate=0.001, decay = 0.0005),keras.optimizers.RMSprop(learning_rate=0.001),],
#     optimizer=[keras.optimizers.RMSprop(learning_rate=0.0003),keras.optimizers.RMSprop(learning_rate=0.001),],
#     optimizer=[keras.optimizers.Adam(learning_rate=0.001),keras.optimizers.Adam(learning_rate=0.001),],
...
data=pd.read_csv('_0bg1TLPP-I.004.mp4.wav_st.csv')
data1=data.to_numpy()
data1.shape
