...
class Applicant(models.Model):
	...
	# resume file
	resume = models.FileField(upload_to=get_resume_upload_path , max_length=254, validators=[FileExtensionValidator(allowed_extensions= ['pdf'])]) # uploads to media_root/uploads/username/resume/
	...
	key_skills = models.JSONField(default=dict)
